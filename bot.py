...
# Здесь храним только пользователей,
# которые прямо сейчас находятся на этапе
# получения телефона.
...
async def notify_admin(
    ...
    # -----------------------------------------------------
    # КЛИКАБЕЛЬНАЯ ССЫЛКА НА ПОЛЬЗОВАТЕЛЯ MAX
    # -----------------------------------------------------
...
async def process_phone(
    ...
    # убираем пользователя из ожидания телефона.
    # =====================================================
...
async def messages(
    ...
    # Это важно, потому что контакт приходит
    # отдельным message_created.
    # =====================================================
    ...
    # =====================================================
    # ГЛАВНАЯ ЗАЩИТА ОТ ПОВТОРНОГО ЗАПРОСА ТЕЛЕФОНА
    #
    # Если пользователь уже есть в БД,
    # НИКОГДА не запускаем регистрацию заново.
    # =====================================================
    ...
    if existing_user:
        ...
        # На всякий случай очищаем временное состояние.
        waiting_phone.discard(
            user_id
        )
        ...
        if existing_user["location"]:
            ...
            # показываем ему актуальное меню.
            #
            # Это НЕ будет снова спрашивать телефон.
            ...
            await event.message.answer(
                ...
                f"📍 Ваш филиал: "
                f"{'Карла Маркса' if existing_user['location'] == 'karla' else 'ТРЦ Матрица'}\n\n"

                "Ниже вы можете оставить отзыв, "
                "написать администратору "
                "или сменить филиал.",
    ...
    # =====================================================
    # ЕСЛИ НОВЫЙ ПОЛЬЗОВАТЕЛЬ УЖЕ НА ЭТАПЕ ТЕЛЕФОНА
    # =====================================================
    ...
    # =====================================================
    # ПЕРВОЕ СООБЩЕНИЕ НОВОГО ПОЛЬЗОВАТЕЛЯ
    # =====================================================
