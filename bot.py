...
#
# Старый токен из предыдущего сообщения нужно перевыпустить.
#
...
# Твой ID.
# Оставляем тебя администратором для /users и тестирования.
ADMIN_IDS = {
    174516690
}
...
async def notify_admin(
    ...
    # -----------------------------------------------------
    # ССЫЛКА / УПОМИНАНИЕ ПОЛЬЗОВАТЕЛЯ MAX
    # -----------------------------------------------------
    #
    # Официальный формат MAX:
    #
    # [Имя Фамилия](max://user/user_id)
    #
    # ВАЖНО:
    # При отправке ниже указываем:
    #
    # format="markdown"
    #
    # -----------------------------------------------------
    ...
    # format="markdown"
    #
    # Без этого MAX не должен воспринимать
    # [Имя](max://user/ID) как упоминание.
    #
    # -----------------------------------------------------
